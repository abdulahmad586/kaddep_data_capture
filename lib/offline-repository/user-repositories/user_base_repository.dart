...
abstract class UserBaseRepository {
  final UserSQLiteController _sqLiteController = UserSQLiteController();
  ...
  Future<List<Object?>> insertRecords(List<MyInsertQuery> queries) async {
    return await _sqLiteController.insertRecords(queries);
  }
  ...
  Future<Map<String, Object?>?> fetchRecordById(int id, String tableName, {String idField="id", List<String> returnFields=const ["*"]}) async {
